...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalScrollBar.setMinimum(-5000)
        self.horizontalScrollBar.setMaximum(5000)
        self.horizontalScrollBar.setPageStep(10)
        self.horizontalScrollBar.setValue(10)
        self.horizontalScrollBar.setOrientation(Qt.Horizontal)
        self.horizontalScrollBar.setFocusPolicy(Qt.FocusPolicy.WheelFocus)
